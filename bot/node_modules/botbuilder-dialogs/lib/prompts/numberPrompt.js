...
const recognizers_text_number_1 = __importDefault(require("@microsoft/recognizers-text-number"));
...
class NumberPrompt extends prompt_1.Prompt {
    ...
    onRecognize(context, _state, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [{ resolution = null } = {}] = recognizers_text_number_1.default.recognizeNumber(utterance, locale) || [];
            if (resolution) {
